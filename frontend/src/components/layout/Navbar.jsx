    ...
    <nav className="sticky top-0 z-40 bg-cinema-dark/90 backdrop-blur-md border-b border-cinema-border">
      <div className="max-w-screen-xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link to="/dashboard" className="flex items-center gap-2.5 group">
          ...
          <span className="font-display text-lg font-bold text-cinema-text hidden sm:block">
            MovieCircle
          </span>
        </Link>
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="text-cinema-text text-sm font-medium hidden sm:block">
              {user?.username}
            </span>

            <svg
              className={`w-4 h-4 text-cinema-subtle transition-transform ${
                showMenu ? 'rotate-180' : ''
              }`}
              fill="none"
              stroke="currentColor"
          ...
          {showMenu && (
            <>
              ...
              <div className="absolute right-0 top-full mt-2 w-56 card shadow-modal z-20 animate-scale-in">
                ...
                <div className="p-3 border-b border-cinema-border">
                  ...
                  <div className="text-xs text-cinema-subtle truncate">
                    {user?.email}
                  </div>
                </div>
                ...
                <div className="p-1">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm text-cinema-text hover:bg-cinema-muted transition-colors"
                  >
                    🔒 Change Password
                  </button>
